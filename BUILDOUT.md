...
| W | EVA & interiors | IN PROGRESS (part 1 DONE 2425746: eva walk scene; part 2 DONE 91efb17: walkable hab interiors w/ airlock/rooms/residents/consoles. **part 3 — DIRECTOR DIRECTIVE 2026-06-11: Terraria-style tile site-worlds**: each landing site = persistent side-view tile world (~2 km × 200 m deep, 0.5 m tiles) seeded per sector; strata + ore/ice veins visible in cross-section (deposits!), DIGGING with canon e_dig rates (hand scoop slow, excavators carve), buried habs/berm cover/lava-tube outfitting literal, asteroids = small wrappable tile worlds; construction stays MODULAR (deploy modules into dug spaces, no freeform block-building); whole planets stay real-scale — the tile world is the local site map (bible S-7c). Tile edits persist in explore state per sector) | walk the surface at any landed site/colony (astronaut controller, terrain from sector), enter modules → walkable interiors, consoles open system screens, flags/sample pickup; THE marquee feature |
