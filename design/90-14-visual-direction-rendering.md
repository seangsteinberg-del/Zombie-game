...
- **Perf HUD (F3) additions** to 13 §3.14's bars: GPU frame ms, upload MB/frame, active degradation rung with reason — the same no-silent-stutter doctrine.
