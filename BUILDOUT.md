...
| G | Power & thermal v2 | IN PROGRESS | thermal node network (H-6), grid dispatch/shedding (P-1), generation/storage/radiator catalogs, sink temps per body, failure modes |
