...
| HOP-P | Crewed hopper | T2 | 12 t | 8 t | ML-111 ×1 (pump-fed methalox, Isp 355 s vac — 02 §4.1, DECISIONS A8) | 1,778 m/s = 3,481·ln(20/12) (→ ~445 km Moon) | crew sorties beyond rover range; abort-to-base reserve mandatory 20% | Apollo LM heritage |
...
10. **Crewed-hopper range vs 02's lander-engine ceiling — RESOLVED (DECISIONS A8)**: 02 published the ML-111 pump-fed methalox lander row (Isp 355 s vac, 02 §4.1); HOP-P is re-quoted against it at 1,778 m/s tank-full (~445 km Moon class) — the 450 km sortie class effectively closes without staged hops.
