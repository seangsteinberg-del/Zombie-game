...
| W | EVA & interiors | IN PROGRESS (part 1 DONE 2425746: eva walk scene, terrain, flags/samples/anomalies-on-foot, suit clock, QA --scene eva; part 2 NEXT: walkable hab interiors — enter habs from EVA via E, side-view room strip per built module, residents inside, console interactions, exit to EVA; station interiors land with chunk T) | walk the surface at any landed site/colony (astronaut controller, terrain from sector), enter modules → walkable interiors, consoles open system screens, flags/sample pickup; THE marquee feature |
