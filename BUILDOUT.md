...
| D | Drydock 2.0 | IN PROGRESS (D1 DONE this commit: tools/gen_parts2.py patches the 37 legacy parts additively with catalog_id/class/size/cost_musd and emits 81 new rows — full 06 catalog now 118 files w/ §5.1 extended schema: structure 15, solids 2, NTR 2 more, EP 8 + RCS 3, power/thermal 10, habs 11, spin/dock/assembly 12, cargo/utility/entry/landing 16, Whipple 3. NEXT per 06 §5.3: D2 grid datamodel sim/vessels/grid.py — w×h footprints at (x,y), attach nodes incl. no_bottom/interior/surface_mount, connected graph, command source/active core, E1–E5; D3 builder math COM/torque/badges/dv/TWR + Build A acceptance test (§4.1 numbers); D4 joint-load spanning tree/max-Q/q·α E6-E7 + pre-flight ascent sim; D5 O/F drain split/flameout/crossfeed + Builds B C D tests; D6 Drydock grid-editor UI scene) | 2D grid builder, ~110-part catalog, O/F plumbing + feed groups, validation E1–E11 + W warns, pre-flight ascent sim, 4 worked builds |
